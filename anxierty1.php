...
<body data-spy="scroll" data-target="#navbar-example">
 ...
 <li><a href="logout.php">Log Out</a></li>
          <li style="color:white;font-size:15px;text-align: justify;padding:5px;"><?php
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Anxiety</a></li></button></ul
</div>
              </div>
              </div>
              <br><br>
