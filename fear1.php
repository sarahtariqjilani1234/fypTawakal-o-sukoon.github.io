...
<body data-spy="scroll" data-target="#navbar-example">
 ...
 <li style="color:white;font-size:20px;text-align: justify;padding:5px;">
<?php
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Fear</a></li></button></ul>
</div>
              </div>
              </div>
              <br><br>
<div class="blog-inner area-padding">
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div id="verses" class="section-headline hadith alignleft"><h2><p>Quranic Verse for Fear</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM quranic_verse where category = 'fear'";
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Fear</a></li></button></ul>
              ...
              <div id="dua" class="section-headline hadith alignleft"><h2><p>Dua for Fear</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM duaa where category = 'fear'";
$result = mysqli_query($mysqli, $sql);
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Fear</a></li></button></ul>
              ...
              <div id="hadees" class="section-headline hadith alignleft"><h2><p>Hadees for Fear</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM dd where category = 'fearh'";
$result = mysqli_query($mysqli, $sql);
