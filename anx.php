          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="section-headline text-center">
                <br><br><br><br><h2>Anxious</h2></div>
            <div id="myBtnContainer">
  
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verse for Anxious</a></li></button>
  <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua"> Dua for Anxious</a></li></button></ul>
<button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Anxious</a></li></button></ul>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Anxious</a></li></button></ul>
</div>
              </div>
              </div>
              <br><br>
<div class="blog-inner area-padding">
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div id="verses" class="section-headline hadith alignleft"><h2><p>Quranic Verse for Anxious</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM quranic_verse where category = 'ans'";
...
<div class="blog-inner area-padding">
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div id="verses" class="section-headline hadith alignleft"><h2><p>Dua for Anxious</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
              
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM duaa where category = 'ans'";
$result = mysqli_query($mysqli, $sql);
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Anxious</a></li></button></ul>
              ...
              <div id="hadees" class="section-headline hadith alignleft"><h2><p Hadees for Anxious</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM hadees where category = 'ans'";
$result = mysqli_query($mysqli, $sql);
