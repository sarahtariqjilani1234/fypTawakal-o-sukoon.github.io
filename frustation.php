...
<body data-spy="scroll" data-target="#navbar-example">
 ...
 <div id="blog" class="blog-area">
  ...
  <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees forFrustration</a></li></button>
...
<div class="blog-inner area-padding">
  ...
  <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees forFrustration</a></li></button>
              ...
              <div id="dua" class="section-headline hadith alignleft"><h2><p>Dua for Frustration</p></h2></div></div></div>
