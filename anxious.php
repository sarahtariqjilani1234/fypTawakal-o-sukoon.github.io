...
<button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Anxious</a></li></button></ul>
              ...
              <div id="dua" class="section-headline hadith alignleft"><h2><p>Dua for Anxious</p></h2></div></div></div>
...
<button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Anxious</a></li></button></ul>
                ...
                <div id="verses" class="section-headline hadith alignleft"><h2><p>Hadees for Anxious</p></h2></div></div></div>
