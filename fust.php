        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <br>   <h2>Frustration</h2></div>
            <div id="myBtnContainer">
  
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verses for Frustration</a></li></button>
  <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Frustration</a></li></button></ul>
 <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua"> Dua for Frustration</a></li></button>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Frustration</a></li></button></ul>
</div>
...
<div class="blog-inner area-padding">
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div id="verses" class="section-headline hadith alignleft"><h2><p>Quranic Verse for Frustration</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM quranic_verse where category = 'fust'";
...
<div class="blog-inner area-padding">
  ...
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verse for Frustration</a></li></button>
  <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua">Dua for Frustration</a></li></button></ul>
 <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Frustration</a></li></button>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Frustration</a></li></button></ul>
</div>
         
              <div id="dua" class="section-headline hadith alignleft"><h2><p>Dua for Frustation</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM duaa where category = 'fust'";
$result = mysqli_query($mysqli, $sql);
...
<div class="blog-inner area-padding">
  ...
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verses for Frustration</a></li></button>
  <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua"> Dua for Frustation</a></li></button></ul>
  <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Frustration</a></li></button>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Frustration</a></li></button></ul>
</div>
         
              <div id="hadees" class="section-headline hadith alignleft"><h2><p>Hadees for Frustration</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM hadees where category = 'fust'";
$result = mysqli_query($mysqli, $sql);
...
?>      
  ...
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verses for Fear</a></li></button>
