...
<div class="blog-inner area-padding">
 ...
 <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Anxiety</a></li></button></ul>
          ...
          <br>    <div id="dua" class="section-headline hadith alignleft"><h2><p>Dua for Anxiety</p></h2></div></div></div>
...
<div class="blog-inner area-padding">
 ...
 <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Anxiety</a></li></button></ul>
              ...
              <div id="dua" class="section-headline hadith alignleft"><h2><p>Hadees for Anxiety</p></h2></div></div></div>
