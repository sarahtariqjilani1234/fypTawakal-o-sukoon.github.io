...
?>
 ...
 <div id="blog" class="blog-area">
  ...
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verse for Anger</a></li></button>
  <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua"> Dua for Anger</a></li></button></ul>
  <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees  for Anger</a></li></button></ul>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Anger</a></li></button></ul>
</div>
...
<div class="blog-inner area-padding">
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div id="verses" class="section-headline hadith alignleft"><h2><p>Quranic Verse for Anger</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM quranic_verse where category = 'angery'";
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Anger</a></li></button></ul>
              ...
              <div id="dua" class="section-headline hadith alignleft"><h2><p>Dua  for Anger</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM duaa where category = 'angery'";
$result = mysqli_query($mysqli, $sql);
...
<div class="blog-inner area-padding">
  ...
  <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua"> Dua  for Anger</a></li></button></ul>
  <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees  for Anger</a></li></button></ul>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for A+nger</a></li></button></ul>
</div>
              <div id="hadees" class="section-headline hadith alignleft"><h2><p>Hadees  for Anger</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM hadees where category = 'angery'";
$result = mysqli_query($mysqli, $sql);
...
?>      
  ...
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verses for Anger</a></li></button>
  <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua"> Dua for Anger</a></li></button></ul>
 <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Anger</a></li></button></ul>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for Anger</a></li></button></ul>
</div>
