...
?>
 ...
 <div id="blog" class="blog-area">
  ...
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verse for Guilt</a></li></button>
  <button class="btn" onclick="filterSelection('dua')"><li><a href="#dua"> Dua for Guilt</a></li></button></ul>
 <button class="btn" onclick="filterSelection('hadees')"><li><a href="#hadees"> Hadees for Guilt</a></li></button></ul>
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for guilt</a></li></button></ul>
</div>
              </div>
              </div>
              <br><br>
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div id="verses" class="section-headline hadith alignleft"><h2><p>Quranic Verse for Guilt</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM quranic_verse where category = 'guilt'";
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for guilt</a></li></button></ul>
              ...
              <div id="dua" class="section-headline hadith alignleft"><h2><p>Dua for Guilt</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM duaa where category = 'guilt'";
$result = mysqli_query($mysqli, $sql);
...
<button class="btn" onclick="filterSelection('com')"><li><a href="#com"> Comment for guilt</a></li></button></ul>
              ...
              <div id="hadees" class="section-headline hadith alignleft"><h2><p>Hadees for Guilt</p></h2></div></div></div>
                  
               <div class="hadith text-center"><h4><p>
<?php
$mysqli = mysqli_connect('localhost','root','','projects');
$sql = "SELECT * FROM dd where category = 'guilt1'";
$result = mysqli_query($mysqli, $sql);
