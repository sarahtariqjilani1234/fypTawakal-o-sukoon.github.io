...
<body data-spy="scroll" data-target="#navbar-example">
 ...
 <div id="blog" class="blog-area">
  ...
  <ul><button class="btn active" onclick="filterSelection('all')"> Show all</button>
  <button class="btn" onclick="filterSelection('verses')"><li><a href="#verses"> Quranic verses for Depression</a></li></button>
  <button class="btn" onclick="filterSelection('hadith')"><li><a href="#hadith"> Hadiths for Depression</a></li></button></ul>
</div>
              </div>
              </div>
              <br><br>
<div class="blog-inner area-padding">
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div id="verses" class="section-headline hadith alignleft"><h2><p>Quranic Verse for Depression</p></h2></div></div></div>
...
<div class="blog-inner area-padding">
        ...
        <div class="container ">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div id="hadith" class="section-headline hadith alignleft"><h2><p>Hadiths for Depression</p></h2></div></div></div>
